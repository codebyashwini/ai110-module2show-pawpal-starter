...
class Scheduler:
    ...
    def generate_schedule(self) -> 'DailySchedule':
        """Returns a DailySchedule for the given owner and pet."""
        pass
    ...
    def fit_tasks_in_time(self, tasks: List[Task], available_minutes: int) -> List[Task]:
        """Returns tasks that fit in available time, dropping low-priority ones if needed."""
        pass
...
class DailySchedule:
    ...
    def __init__(self, date_obj: date, pet: Pet, scheduled_tasks: Optional[List['ScheduledTask']] = None):
        self.date = date_obj
        self.pet = pet
    ...
    def explain_reasoning(self) -> str:
        """Returns why each task was chosen or dropped."""
        pass
...
class ScheduledTask:
    ...
    def __init__(self, task: Task, start_time: str, end_time: str, explanation: str = ""):
        self.task = task
